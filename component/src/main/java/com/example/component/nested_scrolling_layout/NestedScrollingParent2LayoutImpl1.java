package com.example.component.nested_scrolling_layout;
...
public class NestedScrollingParent2LayoutImpl1 extends NestedScrollingParent2Layout implements NestedScrollingParent2 {
    ...
    public void setTopView(View mTopView) {
        this.mTopView = mTopView;
    }

    public void setTabLayout(View mTabLayout) {
        this.mTabLayout = mTabLayout;
    }

    public void setViewPager(View mViewPager) {
